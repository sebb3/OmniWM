.PHONY: format format-check lint lint-fix build run energy-profile test-skylight-live release-check verify check dock-payload-check check-tool-versions check-swiftformat-version check-swiftlint-version
